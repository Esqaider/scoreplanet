...
<!-- шаблон страницы содержит внутреннюю (контентную) часть  старницы, он разный для каждой страницы. Может использовать динамические данные из массива $data и может подключать другие шаблоны (хотя вам пока не нужно этим злоупотреблять) 

// Не понимаю: возьмем для примера следующий кода моего файла header:

 Правильно ли я понимаю, что это уже можно назвать шаблоном? Я называю его header.php, а в этом файле подключаю его в строку 3, указав название "header@/
 Еще не понятно, что в этом коде header можно поместить в массив $data? У вас указано "text", но мне мало что это говорит.
	-->
